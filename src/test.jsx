      ...
      >
        ...
        {isShown && (
          <div
            ...
            onClick={() => column.deleteNote(column.id)}
          >
            <Trash />
          </div>
        )}
            ...
            <div key={columnId}>
              <div className="container">
                ...
                >
                  <h3
                    className="dark-blue"
                    style={{ color: column.headingColor }}
                  >
                    {column.heading1}
                    <br></br>
                    <strong>{column.heading2}</strong>
                    <OverlayTrigger
                      key="bottom"
                      placement="bottom"
                      overlay={
                        <Tooltip id={`tooltip-bottom`}>
                          <strong> What The World Needs</strong> <br /> Are you
                          helping to solve an actual problem? <br /> Is what
                          you’re doing bringing beauty or utility to others,
                          helping out, and shaping the world around you?
                        </Tooltip>
                      }
                    >
                      <span>
